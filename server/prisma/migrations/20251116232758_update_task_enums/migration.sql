...
-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('TODO', 'IN_PROGRESS', 'INTERNAL_REVIEW', 'DONE', 'CANCELLED');

-- CreateEnum
CREATE TYPE "TaskType" AS ENUM ('GENERAL_TASK', 'WEEKLY_EMAILS', 'CALENDARS', 'CLIENT', 'SOCIAL', 'OTHER');
...
CREATE TABLE "Task" (
    ...
    "type" "TaskType" NOT NULL DEFAULT 'GENERAL_TASK',
    "priority" "Priority" NOT NULL DEFAULT 'MEDIUM',
